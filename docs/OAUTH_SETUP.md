...
설치 방법이 두 군데에서 달라지지 않도록, 최신 안내는 **[README의 처음 설치하기](../README.md#-처음-설치하기-1회-약-10분)** 한 곳에서 관리합니다.
...
설치 스크립트는 `.env` 형식을 먼저 확인하고, Bun과 필요한 파일을 설치하고, 앱을 빌드하고, 로그인 시 자동으로 실행되도록 등록합니다. 마지막에는 `localhost:8787` 응답까지 확인합니다.
